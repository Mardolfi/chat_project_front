...
function SignUp({ user, signUpDispatch }) {
  ...
  function createUser(e) {
    ...
    signUpDispatch(firstName, lastName, email, password);
  }
    ...
    <Container>
      ...
      <FormContainer>
        ...
        >
          <InputsContainer>
            <FirstAndLastName>
              <Input
                ...
                type={"text"}
                handleValue={(value) => setFirstName(value)}
              />
              <Input
                placeholder={"Last Name"}
                type={"text"}
                handleValue={(value) => setLastName(value)}
              />
            </FirstAndLastName>
            <Input
              placeholder={"Email"}
          ...
          <button>{user.loading ? <img src={loading} /> : "Sign Up"}</button>
          <p>
